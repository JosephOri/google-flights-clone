...
import { FlightLeg } from '@/app/types/flight.types';
        ...
        <Box key={index}>
          ...
          >
            <Box>
              ...
              <Typography color="red">Flight {leg.flightNumber}</Typography>
            </Box>
            ...
            <Box sx={{ flex: 1, display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              <Box sx={{ flex: 1, textAlign: 'center' }}>
                <Typography variant="body2" color="white">
                  {formatDuration(new Date(leg.arrival.time).getTime() - new Date(leg.departure.time).getTime())}
                </Typography>
              </Box>
            </Box>
